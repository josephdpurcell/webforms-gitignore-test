  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['permissions'] = [
      ...
      '#options' => [
        ...
        'view_any' => ['title' => $this->t('View all submissions')],
        'update_any' => ['title' => $this->t('Update all submissions')],
        'delete_any' => ['title' => $this->t('Delete all submissions')],
        'purge_any' => ['title' => $this->t('Purge all submissions')],
