  ...
  public function testSubmissionViews() {
    ...
    \Drupal::configFactory()->getEditable('webform.settings')
      ->set('settings.default_submission_views', [
        'global' => [
          'view' => 'webform_submissions:embed_global',
    ...
    $this->assertRaw('view-id-webform_submissions view-display-id-embed_global');
    ...
    $this->assertNoRaw('view-id-webform_submissions view-display-id-embed_global');
    ...
    $this->drupalGet('/webform/test_submission_views/drafts');
    $this->assertRaw('webform-results-table');
    $this->assertNoRaw('view-id-webform_submissions view-display-id-embed_user');
